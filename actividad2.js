const ImageHandler = require('./ImageHandler2.js')
...
function redConverter() {
    ...
    for(let row = 0; row < width; row++) {
        for(let col = 0; col < height; col++) {
            ...
            // Establece los canales verde y azul en 0, convirtiendo el píxel en un tono rojo.
            pixels.set(row, col, 1, 0); // Verde a cero
            pixels.set(row, col, 2, 0); // Azul a cero
...
function greenConverter() {
    ...
    for(let row = 0; row < width; row++) {
        for(let col = 0; col < height; col++) {
            ...
            // Establece los canales rojo y azul en 0, convirtiendo el píxel en un tono verde.
            pixels.set(row, col, 0, 0); // Rojo a cero
            pixels.set(row, col, 2, 0); // Azul a cero
...
function blueConverter() {
    ...
    for(let row = 0; row < width; row++) {
        for(let col = 0; col < height; col++) {
            ...
            // Establece los canales verde y rojo en 0, convirtiendo el píxel en un tono azul.
            pixels.set(row, col, 0, 0); // Rojo a cero
            pixels.set(row, col, 1, 0); // verde a cero
...
function greyConverter() {
    ...
    pixels = pixels.map(row => row.map(pixel => {
